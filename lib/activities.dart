          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text('My Activities'.toUpperCase(),
...
class Coupon {
  ...
  final bool claimed;
  final DateFormat format = DateFormat("dd MMMM yyyy, HH:MM a");
  ...
  String get date => "Expired on: ${format.format(expiry.subtract(Duration(days: 39)))}";
}
